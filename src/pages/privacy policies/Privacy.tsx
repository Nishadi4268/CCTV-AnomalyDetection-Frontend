...
function Privacy() {
  ...
  <h1 className="flex md:hidden text-center text-14 font-productsans">
    Welcome to SafeVision CCTV Security System. We are committed to protecting your surveillance data and personal information. This Privacy Policy explains how we handle your video footage and account information.
  </h1>
  ...
  <div className="flex flex-col md:flex-row w-full">
    ...
    <div className="w-full pb-[76px] md:w-[55%] xl-1800:w-[75%] flex flex-col md:border-t md:border-l border-black md:gap-[16px] md:pl-[30px] lg-1200:pl-[68px] pt-[26px] md:pt-[53px] overflow-auto">
      <h1 className="hidden md:flex text-14 font-productsans">
        Welcome to SafeVision CCTV Security System. We are committed to protecting your surveillance data and personal information. This Privacy Policy explains how we handle your video footage and account information while providing our AI-powered security services.
      </h1>
          ...
          >
            ...
            <div className="mt-[16px] md:mt-[36px] h-full bg-[#1A3A6D] hidden md:flex">
              <div
                ...
                style={{
                  borderColor: activeIndex === index ? "#417bda" : "#1A3A6D"
                }}
              ></div>
            </div>
            <div
